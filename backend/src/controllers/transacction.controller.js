...
const transaction_service_1 = __importStar(require("../services/transaction.service"));
let TransactionController = class TransactionController {
    getAllTransactions() {
        return __awaiter(this, void 0, void 0, function* () {
            return transaction_service_1.default.getAllTransactions();
        });
    }
    getTransactionById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return transaction_service_1.default.getTransactionId(id);
        });
    }
