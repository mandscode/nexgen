...
const investment_service_1 = __importStar(require("../services/investment.service"));
let InvestmentController = class InvestmentController {
    getAllInvestments() {
        return __awaiter(this, void 0, void 0, function* () {
            return investment_service_1.default.getAllInvestments();
        });
    }
    getInvestmentById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return investment_service_1.default.getInvestmentId(id);
        });
    }
    createInvestment(investment) {
        return __awaiter(this, void 0, void 0, function* () {
            return investment_service_1.default.createInvestment(investment);
        });
    }
};
