...
let ContentController = class ContentController {
    ...
    getContentById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return content_service_1.default.getContentById(id);
        });
    }
    createContent(content) {
        return __awaiter(this, void 0, void 0, function* () {
            return content_service_1.default.createContent(content);
        });
    }
    deleteContent(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const isDeleted = yield content_service_1.default.deleteContent(id);
            if (isDeleted) {
    ...
    updateContent(id, contentData) {
        return __awaiter(this, void 0, void 0, function* () {
            return content_service_1.default.updateContent(id, contentData);
        });
    }
};
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [content_service_1.ContentDTO]),
    __metadata("design:returntype", Promise)
