...
function RegisterRoutes(app) {
    ...
    const argsUserController_login = {
        body: { "in": "body", "name": "body", "required": true, "dataType": "nestedObjectLiteral", "nestedProperties": { "generateBiometricToken": { "dataType": "boolean", "required": true }, "biometricToken": { "dataType": "string" }, "entity": { "dataType": "double" }, "password": { "dataType": "string", "required": true }, "email": { "dataType": "string", "required": true } } },
    };
