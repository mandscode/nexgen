...
function RegisterRoutes(app) {
    ...
    const argsUserController_login = {
        body: { "in": "body", "name": "body", "required": true, "dataType": "nestedObjectLiteral", "nestedProperties": { "token": { "dataType": "string" }, "generateBiometricToken": { "dataType": "boolean" }, "biometricToken": { "dataType": "string" }, "entity": { "dataType": "double" }, "password": { "dataType": "string" }, "email": { "dataType": "string", "required": true } } },
    };
