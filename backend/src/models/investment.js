...
__decorate([
    (0, sequelize_typescript_1.Column)({
        type: sequelize_typescript_1.DataType.ENUM('variable', 'fixed'),
        allowNull: false,
    }),
...
__decorate([
    ...
    __metadata("design:type", String)
], Investment.prototype, "modifiedBy", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => account_1.default),
    __metadata("design:type", account_1.default)
], Investment.prototype, "account", void 0);
