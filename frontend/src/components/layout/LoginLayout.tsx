                        ...
                        <div className="_login_services_cards">
                            <Link to={'/projects'} className="_login_services_card">
                                <span className="_login_services_card_icon_wrapper">
                                    <svg className="_login_services_card_icon" xmlns="http://www.w3.org/2000/svg" width="29" height="28" viewBox="0 0 29 28" fill="none">
                            ...
                            <Link to={'/academy'} className="_login_services_card">
                                <span className="_login_services_card_icon_wrapper">
                                    <svg className="_login_services_card_icon" xmlns="http://www.w3.org/2000/svg" width="25" height="26" viewBox="0 0 25 26" fill="none">
